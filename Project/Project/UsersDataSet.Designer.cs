...
namespace Project {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string username, string password, string firstname, string lastname, System.DateTime DOB, string email, long phone) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public long phone {
                get {
                    try {
                        return ((long)(this[this.tableTable.phoneColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Project.UsersDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table] ([username], [password], [firstname], [lastname], [DOB], [email], [phone]) VALUES (@username, @password, @firstname, @lastname, @DOB, @email, @phone);
SELECT Id, username, password, firstname, lastname, DOB, email, phone FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [username] = @username, [password] = @password, [firstname] = @firstname, [lastname] = @lastname, [DOB] = @DOB, [email] = @email, [phone] = @phone WHERE (([Id] = @Original_Id) AND ([username] = @Original_username) AND ([password] = @Original_password) AND ([firstname] = @Original_firstname) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)));
SELECT Id, username, password, firstname, lastname, DOB, email, phone FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, password, firstname, lastname, DOB, email, phone FROM dbo.[T" +
                "able]";
        ...
        public virtual int Delete(int Original_Id, string Original_username, string Original_password, string Original_firstname, string Original_lastname, global::System.Nullable<global::System.DateTime> Original_DOB, string Original_email, global::System.Nullable<long> Original_phone) {
            ...
            if ((Original_phone.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[11].Value = ((long)(Original_phone.Value));
            }
            else {
        ...
        public virtual int Insert(string username, string password, string firstname, string lastname, global::System.Nullable<global::System.DateTime> DOB, string email, global::System.Nullable<long> phone) {
            if ((username == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_phone.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((long)(Original_phone.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, string firstname, string lastname, global::System.Nullable<global::System.DateTime> DOB, string email, global::System.Nullable<long> phone, int Original_Id, string Original_username, string Original_password, string Original_firstname, string Original_lastname, global::System.Nullable<global::System.DateTime> Original_DOB, string Original_email, global::System.Nullable<long> Original_phone) {
            return this.Update(username, password, firstname, lastname, DOB, email, phone, Original_Id, Original_username, Original_password, Original_firstname, Original_lastname, Original_DOB, Original_email, Original_phone, Original_Id);
        }
    }
